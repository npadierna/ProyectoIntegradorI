package co.edu.udea.android.omrgrader.process.exam.session;
 ...
 */
public final class ExamSessionGrader implements Parcelable, Serializable {
	...
	public ExamSessionGrader(Parcel parcel) {
	...
	public ExamSessionGrader(Context context, String referenceExamAbsolutePath,
	...
	public static final Parcelable.Creator<ExamSessionGrader> CREATOR = new Parcelable.Creator<ExamSessionGrader>() {

		@Override()
		public ExamSessionGrader createFromParcel(Parcel source) {

			return (new ExamSessionGrader(source));
		}

		@Override()
		public ExamSessionGrader[] newArray(int size) {

			return (new ExamSessionGrader[size]);
		}
	};
}