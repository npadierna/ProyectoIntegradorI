...
public class ExamSessionComparator {
	...
	public ExamSessionComparator(Context context, ExamSessionGrader examGraderSession) {
		this.setContext(context);
		this.setExamGraderSession(examGraderSession);
	}

	public ExamSessionGrader getExamGraderSession() {

		return (this.examGraderSession);
	}

	public void setExamGraderSession(ExamSessionGrader examGraderSession) {
