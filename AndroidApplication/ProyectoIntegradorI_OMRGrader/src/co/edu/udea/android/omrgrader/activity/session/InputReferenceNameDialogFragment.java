 ...
 */
public class InputReferenceNameDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View view = layoutInflater.inflate(
				R.layout.dialog_fragment_input_reference_name, null);

		this.inputReferenceNameEditText = (EditText) view
				.findViewById(R.id.inputReferenceNameEditText);
